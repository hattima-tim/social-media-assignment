    ...
    <div className="_layout_left_sidebar_wrap">
      ...
      <div className="_layout_left_sidebar_inner">
        <div className="_left_inner_area_suggest _padd_t24  _padd_b6 _padd_r24 _padd_l24 _b_radious6 _feed_inner_area">
          ...
          {[
            { name: "Steve Jobs", role: "CEO of Apple", img: "people1.png", cls: "_info_img" },
            { name: "Ryan Roslansky", role: "CEO of Linkedin", img: "people2.png", cls: "_info_img1" },
            { name: "Dylan Field", role: "CEO of Figma", img: "people3.png", cls: "_info_img1" },
          ].map((p) => (
            <div className="_left_inner_area_suggest_info" key={p.name}>
              <div className="_left_inner_area_suggest_info_box">
                <div className="_left_inner_area_suggest_info_image">
                  <a href="#0">
                    <img src={`/assets/images/${p.img}`} alt="Image" className={p.cls} />
                  </a>
                </div>
