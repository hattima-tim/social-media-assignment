...
const NOTIFICATIONS = [
  { img: "friend-req.png", name: "Steve Jobs", text: "posted a link in your timeline." },
  { img: "profile-1.png", name: "Freelacer usa", text: "An admin changed the name of the group" },
  { img: "friend-req.png", name: "Steve Jobs", text: "posted a link in your timeline." },
  { img: "profile-1.png", name: "Freelacer usa", text: "An admin changed the name of the group" },
  { img: "friend-req.png", name: "Steve Jobs", text: "posted a link in your timeline." },
  { img: "profile-1.png", name: "Freelacer usa", text: "An admin changed the name of the group" },
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
                      ...
                      {NOTIFICATIONS.map((n, i) => (
                        <div className="_notification_box" key={i}>
                          <div className="_notification_image">
                            <img src={`/assets/images/${n.img}`} alt="Image" className="_notify_img" />
                          </div>
          ...
          <div className="_header_nav_profile">
            <div className="_header_nav_profile_image">
              <Avatar user={me} size={24} className="_nav_profile_img" />
            </div>
            ...
            <div className={`_nav_profile_dropdown _profile_dropdown ${profileOpen ? "show" : ""}`}>
              <div className="_nav_profile_dropdown_info">
                <div className="_nav_profile_dropdown_image">
                  <Avatar user={me} size={54} className="_nav_drop_img" />
                </div>
